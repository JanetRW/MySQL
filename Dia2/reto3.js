...
// imparten.
        ...
        // let params = [];
        // let sql = " SELECT first_name, last_name, title FROM teachers JOIN subject_teacher ON ( subject_teacher.teacher_id = teachers.teacher_id ) JOIN subjects ON ( subject_teacher.subject_id = subjects.subject_id ) ";
...
// apellidos del profesor que la imparte.
        ...
        console.log("-------------------RETO 5-------------------------------------")
        // let sql5 = " SELECT subjects.title, COUNT(students.student_id), teachers.first_name, teachers.last_name FROM students JOIN subject_teacher ON (students.grupo_id = subject_teacher.grupo_id) JOIN subjects ON (subject_teacher.subject_id = subjects.subject_id) JOIN teachers ON (subject_teacher.teacher_id = teachers.teacher_id) GROUP BY subjects.title"; 
        // let [resultado5] = await connection.query(sql5);
        // console.log("Total de alumnos por asignatura y nombre y apellidos de profesor");
        // console.log(resultado5);
        // let params = [];
        // let sql5 = `SELECT COUNT(*) AS students_num, title AS subjects, t.first_name AS teacher_name, t.last_name AS teacher_lastname FROM subjects AS sub
